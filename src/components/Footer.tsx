        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-12 gap-10">
          ...
          <div className="md:col-span-2">
            ...
            <ul className="mt-4 space-y-2 text-[14px] text-[color:var(--ed-ink-2)]">
              ...
              <li><Link to="/tracks" className="hover:text-[color:var(--ed-ink)]">{t.footer?.certificationTracks || (language === 'nl' ? 'Certificeringstrajecten' : 'Certification tracks')}</Link></li>
              <li><Link to="/in-company" className="hover:text-[color:var(--ed-ink)]">{t.footer?.inCompany || (language === 'nl' ? 'In-company' : 'In-company')}</Link></li>
              <li><Link to="/teams" className="hover:text-[color:var(--ed-ink)]">{t.footer?.teamPlans || (language === 'nl' ? 'Teamplannen' : 'Team plans')}</Link></li>
