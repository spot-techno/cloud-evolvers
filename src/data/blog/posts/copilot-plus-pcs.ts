...
export const copilotPlusPcsPost: BlogPost = {
  ...
  excerpt: {
    en: 'Copilot+ PCs require a 40+ TOPS Neural Processing Unit and enable Windows AI features that run entirely on-device. For enterprise IT, this means new hardware planning, ARM compatibility testing, and rethinking your refresh cycle.',
